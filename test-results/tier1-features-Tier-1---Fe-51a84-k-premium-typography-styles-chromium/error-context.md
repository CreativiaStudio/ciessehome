...
- Name: tier1-features.spec.ts >> Tier 1 - Feature Coverage >> F1-2: Check premium typography styles
- Location: tests\tier1-features.spec.ts:17:7
...
Locator: locator('[data-testid="hero"] h1')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="hero"] h1')
